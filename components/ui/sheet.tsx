    ...
    <SheetPortal>
      ...
      <SheetViewport>
        <SheetPrimitive.Popup
          ...
          data-side={side}
          className={cn(
            "pointer-events-none flex h-full w-full transition duration-200 ease-in-out data-[side=bottom]:items-end data-[side=bottom]:justify-center data-[side=left]:items-stretch data-[side=left]:justify-start data-[side=right]:items-stretch data-[side=right]:justify-end data-[side=top]:items-start data-[side=top]:justify-center data-open:animate-in data-open:fade-in-0 data-[side=bottom]:data-open:slide-in-from-bottom-10 data-[side=left]:data-open:slide-in-from-left-10 data-[side=right]:data-open:slide-in-from-right-10 data-[side=top]:data-open:slide-in-from-top-10 data-closed:animate-out data-closed:fade-out-0 data-[side=bottom]:data-closed:slide-out-to-bottom-10 data-[side=left]:data-closed:slide-out-to-left-10 data-[side=right]:data-closed:slide-out-to-right-10 data-[side=top]:data-closed:slide-out-to-top-10",
          )}
          {...props}
        >
          <div
          ...
          >
            ...
            {showCloseButton && (
              ...
              >
                <XIcon />
                <span className="sr-only">{localization.close}</span>
              </SheetPrimitive.Close>
            )}
          </div>
        </SheetPrimitive.Popup>
